...
export const LoginPage = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* Login Form */}
      <form onSubmit={handleEmailLogin} style={{ marginTop: '1.5rem' }}>
      ...
      <div style={{ 
        ...
        <p style={{ fontSize: '0.8125rem', color: 'var(--text-tertiary)' }}>
          ...
          <a href="#" style={{ color: 'var(--text-secondary)', fontWeight: '500' }}>Terms of Service</a>
          {' '}and{' '}
